/*
  # Alpha Program Setup - Profiles and Applications

  1. New Tables
    - `profiles` - Extends auth.users with alpha and admin flags
    - `membership_applications` - Stores alpha program applications
  ...
  3. Functions
    - Create functions to handle user creation and application management
*/
