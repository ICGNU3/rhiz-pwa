...
export default function TrustChart({ data, className = '' }: TrustChartProps) {
  if (!data || data.length === 0) {
    return (
      <div className={`h-64 flex items-center justify-center bg-gray-50 dark:bg-gray-700 rounded-lg ${className}`}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            30-day relationship trust evolution
          </p>
        </div>
